  ...
  return (
    <p>
      ...
      <div>
        ...
        <div>
          {/* {ratingaverage() >2 ? "Good stars" : "Bad stars"} */}

          {ratingaverage() > 1 && ratingaverage() < 2 ? (
            <div className=" flex">
              <img
                className=" w-6 h-6 rounded-full"
                src="https://cdn0.iconfinder.com/data/icons/small-n-flat/24/678064-star-256.png"
                alt=""
              />

              <img
                className=" w-6 h-6 rounded-full"
                src="https://cdn2.iconfinder.com/data/icons/flat-design-basic-set-9/24/star-half-grayed-256.png"
                alt=""
              />
            </div>
          ...
          ) : ratingaverage() > 3 && ratingaverage() < 4 ? (
            <div>
              <div className=" flex">
                <img
                  className=" w-6 h-6 rounded-full"
          ...
          ) : ratingaverage() > 4 && ratingaverage() < 5 ? (
            <div className=" flex">
              <img
                className=" w-6 h-6 rounded-full"
                src="https://cdn0.iconfinder.com/data/icons/small-n-flat/24/678064-star-256.png"
      ...
      <div>
        <p className=" flex gap-4">
          {" "}
          <p className="pt-[5px]">Ratings from</p>{" "}
          <p className=" font-bold text-red-600 pt-[5px]">
